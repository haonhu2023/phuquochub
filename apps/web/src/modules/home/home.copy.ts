...
const vi: HomeCopy = {
  ...
  rightNowEmptyBody: 'Các địa điểm có giờ mở cửa hiện tại đã được đối chiếu nguồn đang được cập nhật.',
...
const en: HomeCopy = {
  ...
  rightNowEmptyBody: 'Places with source-verified current opening hours are still being added.',
