import { SeedPlaceEditProposalPermissions1720006800000 } from '../1720006800000-SeedPlaceEditProposalPermissions';
...
describe('SeedPlaceEditProposalPermissions migration', () => {
  it('up: thêm đúng 2 quyền, scope NULL', async () => {
    ...
    await new SeedPlaceEditProposalPermissions1720006800000().up(qr);
  ...
  it('down: xoá đúng 2 quyền theo code', async () => {
    const { qr, calls } = recordingRunner();
    await new SeedPlaceEditProposalPermissions1720006800000().down(qr);
