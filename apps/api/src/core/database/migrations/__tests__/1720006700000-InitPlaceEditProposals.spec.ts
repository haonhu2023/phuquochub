...
import { InitPlaceEditProposals1720006700000 } from '../1720006700000-InitPlaceEditProposals';

describe('InitPlaceEditProposals1720006700000', () => {
  let migration: InitPlaceEditProposals1720006700000;
  let queryRunner: { query: jest.Mock };

  beforeEach(() => {
    migration = new InitPlaceEditProposals1720006700000();
    queryRunner = { query: jest.fn() };
  });

  it('has the correct migration name', () => {
    expect(migration.name).toBe('InitPlaceEditProposals1720006700000');
  });
