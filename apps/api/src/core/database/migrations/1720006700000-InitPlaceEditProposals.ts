...
// Renamed 2026-09-24 from timestamp 1720005700000 while integrating this branch onto current
// mainline: that number now collides with SeedContentOwnerRole1720005700000, which landed on main
// after this branch's base. Content unchanged — same table/enum/index shape, just resequenced to
// its true position (after everything already on this branch, including 1720006600000
// PlaceEditSuggestions — see that commit for why it was superseded by this more complete branch).
export class InitPlaceEditProposals1720006700000 implements MigrationInterface {
  name = 'InitPlaceEditProposals1720006700000';
