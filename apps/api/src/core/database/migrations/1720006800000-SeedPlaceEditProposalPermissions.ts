...
// Renamed 2026-09-24 from timestamp 1720005800000 (see 1720006700000-InitPlaceEditProposals.ts
// for why) — content unchanged, just resequenced after this table's own migration.
export class SeedPlaceEditProposalPermissions1720006800000 implements MigrationInterface {
  name = 'SeedPlaceEditProposalPermissions1720006800000';
